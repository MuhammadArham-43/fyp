...
config_path = "HardPrompts/sample_config.json"
...
model, _, preprocess = open_clip_model.create_model_and_transforms(args.clip_model, pretrained=args.clip_pretrain, device=device)
